...
pub enum CompoundPinyinStep<'a> {
    Miss { expected: &'a str, total: usize },
    Advanced {
        matched: &'a str,
        next_progress: usize,
        total: usize,
    },
    Completed { matched: &'a str, total: usize },
}
...
#[cfg(test)]
mod tests {
    use super::{check_pinyin, pinyin_syllables, resolve_compound_pinyin_step, CompoundPinyinStep, VOCAB};
